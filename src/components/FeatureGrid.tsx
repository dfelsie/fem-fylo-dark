...
export default function FeatureGrid({}: Props) {
  return (
    <div className="mx-auto w-2/3 grid grid-cols-1 md:grid-cols-2 px-4">
      ...
      <div className="px-8 mt-24 flex flex-col text-center">
        <img className="h-20 mx-auto" src="/assets/images/icon-security.svg" />
      ...
      <div className="px-8 mt-24 flex flex-col text-center">
        <img className="h-20 mx-auto" src="/assets/images/icon-any-file.svg" />
